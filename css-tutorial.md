...
```
[![image](https://github.com/user-attachments/assets/ffd78234-2b7d-4afe-8e59-d9d852a1c9c3)
]
...
```
[![image](https://github.com/user-attachments/assets/54e86fce-cef3-4f09-a699-64d0d9f69deb)
]
...
<html>
<head>
    <link rel="stylesheet" href="/css/modern dashbord.css">
</head>
<body>
    <div class="dashboard">
        <header class="header">
        ...
        <aside class="sidebar">
            <nav>
                <ul>
                    <strong><li>หน้าแรก</li>
                    <li>รายงาน</li>
                    <li>การตั้งค่า</li></strong>
                </ul>
            </nav>
        </aside>
...
```
![image](https://github.com/user-attachments/assets/f6700d1d-774c-48bb-94a1-7c3874c9f561)
